...
export class SettingsMenu extends Phaser.Scene {
  ...
  create(): void {
    ...
    const soundFxButton = new Button(this, 250 * this.scaleCoef, 115 * this.scaleCoef, '#000', 'button', 'button_pressed',
      this.gameSettings[1].value === true ? 'On' : 'Off', 'toggle', 'sfx');
    this.add.text(100 * this.scaleCoef, 280 * this.scaleCoef, 'Music',
      { fontSize: '28px', color: '#ffffff' });
    const musicButton = new Button(this, 250 * this.scaleCoef, 150 * this.scaleCoef, '#000', 'button', 'button_pressed',
      this.gameSettings[0].value === true ? 'On' : 'Off', 'toggle', 'music');
    ...
    const backButton = new Button(this, 180 * this.scaleCoef, 260 * this.scaleCoef,
      '#000', 'button', 'button_pressed', 'Back', 'navigation', 'back', 'main');
  }
